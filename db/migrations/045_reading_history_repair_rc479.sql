-- RC4.79: repair Smart Library / History membership from canonical progress data.
--
-- Earlier builds allowed reading_history to lag behind the Redis progress stream.
